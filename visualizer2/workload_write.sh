...
../ab/ab -G ab_writes.log -l 1 -v 1 -k -t 60 -n 9999999 -c 10 -r -m /home/David.Schwalb/tpcc/queries_gen/revenue_insert_storedproc_5M 127.0.0.1:6666/procedureRevenueInsert/
